        ...
        <div className="border border-white/[0.11] rounded-[3px] px-10 py-14 lg:px-16 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          >
            ...
            <p className="text-sm text-white/65 leading-relaxed max-w-xl">
              INX does not produce technology recommendations before understanding
              how the business operates. The first engagement is a discovery
              conversation - structured, industry-specific, and focused on
              operational constraints before architectural options. If your
              industry or problem context appears on this page, that is the
              starting point.
            </p>

            <p className="mt-6 text-xs text-white/25 leading-relaxed max-w-sm">
              Discovery is a billable engagement that produces a written
              specification. Engineering work does not begin without one.
              This is not a formality - it is the primary mechanism by which
              systems are built to reflect operational reality rather than
