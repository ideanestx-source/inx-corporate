  ...
  return (
    <section className="relative overflow-hidden bg-[#05070e] pt-36 pb-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[560px] h-[290px] rounded-full bg-blue-600/[0.035] blur-[132px]" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <span className="text-white/30">Stated Without Hedging.</span>
            </motion.h1>
          </div>
          ...
          >
            <p className="text-base text-white/68 leading-relaxed mb-8">
              INX publishes selectively. What appears here is written from
              operational experience - not to establish market presence, not to
              rank for search terms, and not to signal alignment with whatever
              the industry is currently excited about.
            </p>

            <div className="flex flex-col gap-4 border-t border-white/[0.09] pt-6">
              {[
                {
                  label: "Publication Basis",
                  value: "Operational experience only",
                },
                {
                  label: "Editorial Standard",
                  value: "Position over commentary",
                },
                {
                  label: "Frequency",
                  value: "When there is something to say",
                },
              ].map((item) => (
                <div
                  key={item.label}
