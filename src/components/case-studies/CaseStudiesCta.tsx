        ...
        <div className="border border-white/[0.11] rounded-[3px] px-10 py-14 lg:px-16 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          >
            ...
            <p className="text-sm text-white/65 leading-relaxed max-w-xl">
              Every engagement in this document began with a structured discovery
              conversation - not a sales call. If you have a defined technical
              problem and need an engineering partner who operates with the same
              precision these case studies demonstrate, the next step is a direct
              conversation.
            </p>

            <div className="mt-8 flex flex-col sm:flex-row items-start gap-4">
              <p className="text-xs text-white/25 leading-relaxed max-w-xs">
                INX does not take on engagements without a discovery phase.
                Discovery produces a written specification before development
                begins. This is a billable engagement and is not waived.
              </p>
            </div>
          </motion.div>
          ...
          >
            {/* Divider */}
            <div className="hidden lg:block w-px self-stretch bg-white/[0.06] absolute" />
