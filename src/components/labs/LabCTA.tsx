...
export default function LabCTA({ cta, heading }: Props) {
  const className =
    "inline-flex items-center gap-2.5 rounded-[3px] bg-blue-500 text-white px-7 py-[13px] text-sm font-semibold hover:bg-blue-400 transition-all duration-200 shadow-[0_0_24px_rgba(59,130,246,0.24)] shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400";
